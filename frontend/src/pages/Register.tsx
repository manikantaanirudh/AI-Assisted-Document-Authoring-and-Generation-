        ...
        <div className="glass-card p-8 animate-fadeInUp">
          <div className="mb-8">
            ...
            <p className="text-silver text-sm">
              Or{' '}
              <Link to="/login" className="text-white hover:text-soft-silver transition-colors underline underline-offset-2">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-silver mb-2">
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
