        ...
        <div className="animate-fadeIn">
          ...
          {loading ? (
            <div className="text-center py-20">
              <div className="text-lg text-silver animate-slowPulse">Loading projects...</div>
            </div>
          ) : projects.length === 0 ? (
            <div className="text-center py-20">
              <div className="glass-card p-12 max-w-md mx-auto">
                <p className="text-silver mb-6 text-lg">No projects yet. Create your first project!</p>
                <Link
                  to="/projects/new"
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {projects.map((project, index) => (
                ...
                >
                  ...
                  <p className="text-silver text-sm mb-4 line-clamp-2">{project.topic}</p>
